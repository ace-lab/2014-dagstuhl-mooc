...
\section{Return on investment in MOOCs is heavily university-dependent}
\label{sec:roi}
...
\tbd{ck: comment by fb: Is "teaching universities" the notion we wish to propagate? Isn't it instead about "vocational higher ediucation"? }
...
\tbd{ck: comment by fb: MOOCs, like the printed book at the time of Humanism, requirte capital and
  skills most educvators toda do not have.

  Europa will not get MOOC platforms and MOOC authors without the necessary capital and without
  educators having the time to dedicate themselves to authoring MOOCs.

  In my opinion, it would be wise that the manifesto being explicit on this.

  In my opinion, continental Europe needs an ecosystems of MOOC-related endeavours, of competing
  MOOC platforms nd MOOC authors.

  This section could also point to the fact that China just started a MOOC platform
  (cnmooc.org). Even though the MOOCs are yet in Chinese, one can expect this platform to soon make
  good MOOC offers in English targeted at non-Chinese students.  }
