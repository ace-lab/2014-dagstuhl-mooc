...
\section{Standards should be developed for measuring participation in MOOCs}

%% section editor: Pierre Dillenbourg (revised by Pierre - 22 mars)

\tbd{ck: comment by fb: Not only standards but also research in the filed. This section could stress
  the need for more applied/experimmental reaseach on learning abnayltics in the context of MOOCs. }
...
\tbd{ck: comment by fb: These are mostly obervations of the students'behavior, not of their
  performances. In my opinion, performeances at quizzes and in peer learnig/teaching should be
  mentioned, too.

  TZhe manifesto could stress that MOOCs make it possible to observe both, the students' behavior
  and their achievements, to realte the one to the other both at an individual and at a group level,
  and to deliver immediate feedback on this to the individuals, the group and the educators.

  Because of this, MOOCs are promising for tradfitional higher education, too. }
...
% An understanding of MOOC participation will bring
...
% transparency in learners' data collection and use, and the availability
...
\tbd{jh: However, we have to accept that, if open-ness and privacy are to be maintained, we shall
  only be able to gather data from those willing to provide it, and that MOOC participation data
  will never be as complete as that for residential, or taught online, education.
  ck: I do not agree with this statement proposition by Jeff} 
