\section{Our community should develop standards for participation metrics}

%% section editor: Pierre Dillenbourg (revised by Pierre - 22 mars)

\tbd{Doug Fisher made numerous annotations/comments in the Google Doc
about related resources/work that should be referenced.}
...
participant's activity in a MOOC (for example, pass/fail). In this section we
